<template>
  <div v-if="state.user.isAuthenticated" class="col-12">
    <div class="card text-dark m-2">
      <h6>Task: {{ task.task }} <i class="fa fa-times text-danger" @click="deleteTask" aria-hidden="true"></i> <i class="fa fa-plus-square text-success" :data-target="`#create-comment` + task._id" data-toggle="modal" aria-hidden="true"></i></h6>
